  ...
  <>
    ...
    <div className="flex items-center justify-center gap-12 p-4">
      {data.map((data) => (
        ...
        >
          <h1 className="text-white text-center text-3xl font-bold">{data.name}</h1>         
          <Image src={data.image} alt={data.name} fill={true} className="absolute inset-0 bg-cover bg-center transition-transform duration-300 -z-10" />
